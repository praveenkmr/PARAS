...
public class RightIrisRegistrationActivity extends AppCompatActivity implements IrisCapture {
    ...
    private String Left_Iris_Code;
    private String Right_Iris_Code;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_right_iris_registration);
        ...
        Left_Iris_Code = intent.getStringExtra("Worker_left_Iris");
        try {
    ...
    public void OnCaptureCompleted(byte[] bytes){
        Right_Iris_Code = String.valueOf(bytes);
        tst = new ShowText();
        tst.execute("Capture Completed ");
        Intent intent = new Intent(this,WorkerRegistration.class);
        intent.putExtra("Worker_Aadhar",WorkerAadharNo);
        intent.putExtra("Worker_Name",WorkerName);
        intent.putExtra("Left_Iris",Left_Iris_Code);
        intent.putExtra("Right_Iris",Right_Iris_Code);
